...
<meta name="csrf-token" content="n2Yz2aXxmYZEVQapphw+kGxhwxL+XogxEOueA6mcuRx8MvfTkXEfPT5cFwa7VQf6HgtSH/hcJ0SRo/FV3/agNw==" />
...
<form class="new_user gl-show-field-errors" aria-live="assertive" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="M7MXazpGFqzkbdLl4XpdcBipdg9jhJ7x/vt6P51sO6TQ59NhDsaQF55kw0r8M2QaasPnAmWGMYR/sxVp6wYijw==" /><div class="form-group">
...
<div class="login-body">
<form class="new_new_user gl-show-field-errors" aria-live="assertive" id="new_new_user" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="df6w9HaYQpVwbJ9KuodxNJ0sW+c5wXHJKKxVuYF6mImWqnT+QhjELgpljuWnzkhe70bK6j/D3ryp5Drv9xCBog==" /><div class="devise-errors">
